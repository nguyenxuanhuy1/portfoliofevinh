...
export const en: TranslationKeys = {
  ...
  defaultName: 'Nguyen Duc Vinh',
  defaultPosition: 'Software Engineer',
  defaultBio: "Hi, I'm Vinh — a software engineer dedicated to building highly optimized technological solutions.",
  ...
  searchBtn: 'Search',
  totalCountLabel: 'Total Projects:',
