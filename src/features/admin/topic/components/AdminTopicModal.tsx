...
import { Modal, Form, Input, Button as AntdButton, Alert } from 'antd'
...
export function AdminTopicModal({
  ...
  return (
    <Modal
      ...
      onCancel={onClose}
      footer={[
        <AntdButton key="cancel" onClick={onClose} disabled={saving}>
          Hủy bỏ
        </AntdButton>,
        <AntdButton key="submit" type="primary" loading={saving} onClick={handleSave}>
          Lưu lại
        </AntdButton>,
      ]}
    >
